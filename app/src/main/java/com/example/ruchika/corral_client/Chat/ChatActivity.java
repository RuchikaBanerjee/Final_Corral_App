...
public class ChatActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(broadcastReceiver, new IntentFilter("com.example.corral_client.Chat.ChatMessage"));
        ...
        /*ChatOperations ChatDBoperation;
        ChatDBoperation = new ChatOperations(getApplicationContext());
        ChatDBoperation.open();
        ChatDBoperation.addChat(toUserName,chatText.getText().toString());
        List list = ChatDBoperation.getAllUsers();

        ChatDBoperation.close();*/
